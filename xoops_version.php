...
$modversion['tables'][0] = 'icricket_deductedpoints';
$modversion['tables'][1] = 'icricket_leaguematches';
$modversion['tables'][2] = 'icricket_opponents';
$modversion['tables'][3] = 'icricket_seasonnames';
$modversion['tables'][4] = 'icricket_leaguenames';
...
$cricket_get_leagues = $xoopsDB->query("SELECT LeagueID, LeagueName FROM ".$xoopsDB->prefix('icricket_leaguenames')." WHERE LeaguePublish = '1' ORDER BY LeagueName");
